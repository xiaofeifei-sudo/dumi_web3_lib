...
本教程的完整代码你可以在 [https://github.com/ant-design/pelican-web3-lib-demo](https://github.com/ant-design/pelican-web3-lib-demo) 找到。
...
请按照提示创建一个新的项目，我们将其命名为 `pelican-web3-lib-demo`，具体的技术栈选择你可以参考下图：
...
接下来，我们安装 Ant Design 和 Pelican Web3 的基础组件到项目中：

```bash
npm i antd pelican-web3-lib --save
```
...
然后访问 [http://localhost:3000/web3](http://localhost:3000/web3) 可以看到你已经在项目中成功使用 Pelican Web3 了 🎉
