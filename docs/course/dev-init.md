...
The complete code of this tutorial can be found at [https://github.com/ant-design/pelican-web3-lib-demo](https://github.com/ant-design/pelican-web3-lib-demo).
...
Please create a new project according to the prompts. We will name it `pelican-web3-lib-demo`. You can refer to the following figure for the specific technical stack selection:
...
Next, we install the basic components of Ant Design and Pelican Web3 to the project:

```bash
npm i pelican-web3-lib --save
```
...
Then visit [http://localhost:3000/web3](http://localhost:3000/web3) to see that you have successfully used Pelican Web3 in the project 🎉
