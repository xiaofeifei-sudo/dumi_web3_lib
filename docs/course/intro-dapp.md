...
<!-- prettier-ignore -->
:::info
In order to help everyone build the front-end user interface of DApp better and interact with the blockchain network better, the Ant Design team has launched a set of Web3 front-end component libraries [Pelican Web3](https://web3.ant.design/). If you have a certain understanding of blockchain basic knowledge, you can go directly to 👉 [Develop DApp](./dev-init.md).
:::
