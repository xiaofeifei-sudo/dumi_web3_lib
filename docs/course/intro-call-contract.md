...
<!-- prettier-ignore -->
:::info
It is complex and error-prone to access the wallet directly with js. We recommend using [Pelican Web3](./dev-init.md) in the project to make DApp development more convenient.
:::
...
In this section, we learned how DApp calls smart contracts. We can use wallet plug-ins or node RPC to call smart contracts. In the next section, we will learn how to use Pelican Web3 to call smart contracts.
