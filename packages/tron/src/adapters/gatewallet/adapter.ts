...
import { openGateWallet, supportGateWallet, isGateApp } from './utils';
import type { ReqestAccountsResponse } from '../tronlink/types';
...
type GateReqestAccountsResponse = GateReqestAccountsResponseErr | string[];

type GateAccountChangeEventRes = string[];
...
export class GateWalletAdapter extends Adapter {
    ...
    async connect(): Promise<void> {
        try {
            ...
            const address = (isGateApp ? wallet.tronWeb.defaultAddress?.base58 : (res as string[])[0]) || '';
