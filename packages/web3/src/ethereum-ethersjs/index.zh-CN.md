...
熟悉 `ethers` 的开发者可以安装 `pelican-web3-lib-ethers` 配合组件库使用，其中绝大部份用法都与 `wagmi` 适配器一致。
...
```tsx | pure
import { EthersWeb3ConfigProvider, useEthersProvider } from 'pelican-web3-lib-ethers-v5'; // 引入 ethers@5.x 的适配器
