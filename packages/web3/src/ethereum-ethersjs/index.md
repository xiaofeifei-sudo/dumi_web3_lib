...
Developers who are familiar with `ethers` can install `pelican-web3-lib-ethers` to use with the component library, most of which are consistent with the `wagmi` adapter.

<NormalInstallDependencies packageNames="pelican-web3-lib pelican-web3-lib-ethers ethers" save="true"></NormalInstallDependencies>
...
<NormalInstallDependencies packageNames="pelican-web3-lib pelican-web3-lib-ethers-v5 ethers@legacy-v5" save="true"></NormalInstallDependencies>

```tsx | pure
import { EthersWeb3ConfigProvider, useEthersProvider } from 'pelican-web3-lib-ethers-v5'; // importing the adapter for ethers@5.x
