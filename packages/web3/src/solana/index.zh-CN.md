...
Ant Design Web3 官方提供了 `pelican-web3-lib-solana` 来适配 Solana，它是一个基于 [Solana Web3.js](https://solana-labs.github.io/solana-web3.js/) 的 Ant Design Web3 Solana 适配器。它为 `pelican-web3-lib` 的组件提供了连接 Solana 的能力。
