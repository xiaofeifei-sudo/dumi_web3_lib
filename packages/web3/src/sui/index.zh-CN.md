...
Ant Design Web3 官方提供了 `pelican-web3-lib-sui` 来适配 Sui。它基于 [@mysten/dapp-kit](https://www.npmjs.com/package/@mysten/dapp-kit) 和 [@mysten/sui](https://www.npmjs.com/package/@mysten/sui) ，为 `pelican-web3-lib` 的组件提供了连接 Sui 的能力。
