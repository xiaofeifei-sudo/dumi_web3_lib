...
Ant Design Web3 officially provides `pelican-web3-lib-sui` to adapt to Sui. It is an Ant Design Web3 Sui adapter based on [@mysten/dapp-kit](https://www.npmjs.com/package/@mysten/dapp-kit) and [@mysten/sui](https://www.npmjs.com/package/@mysten/sui).
